...
| Erind Vora      | Implemented TimerController     | Basics-, safe-, showError-, formatHMS-, stop-Method | 1.5 | yes  |         |
| Klaudio Shkalla | Implemented TimerController     | Refresh-, start-, build- Method                     | 1.5 | yes  |         |
| Erind Vora      | Implemented TaskEditorController| Constructor, build                                  | 2   | yes  |         |
| Klaudio Shkalla | Implemented TaskEditorController| clearTask-, fields-, showError- Method              | 2   | yes  |         |
